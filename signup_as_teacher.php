...
<div class="container">
    <div class="form-container">
        ...
        <form id="teacher-signup-form" action="teacher_signup_process.php" method="post">
        ...
        <div class="link-container">
         <p align="left">   <a href="login as techer.php">Have an account? Log in</a></p>
         <p align="right">   <a href="Signup as student.php">sign up as Student</a></p>
        </div>
    </div>
</div>
<hr>
